    ...
    <div class="col-12 col-lg-4">
        ...
        <!-- <div class="card--block">
            <div class="card--content">
                <div class="post--info--item">
                    <b-field class="field-group flex-column">
                        <label class="label">{{$t('blocks')}}</label>
                        <v-select
                            :options="blocks"
                            v-model="postInfo.blocks"
                            label="name"
...
export default {
    ...
    methods: {
        ...
        // Fetch Blocks
        async fetchBlocks(filters) {
            const blocks = await blocksRepository.getAllBlocks(1, 20, filters);
