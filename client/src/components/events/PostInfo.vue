            ...
            <div class="card--content">
                <div class="post--info--item">
                    <b-field class="field-group flex-column">
                        ...
                        <datetime type="datetime" class="custom--datetime theme-primary" placeholder="Event Date"
                            v-model="postInfo.eventDate" use12-hour>
                        </datetime>
                    </b-field>
                </div>
            </div>
            ...
            <div class="card--content">
                ...
                <div class="post--info--item">
                    <b-field class="field-group flex-column">
                        ...
                        <div>
                            <v-select :options="allType" v-model="typeContent" label="name" placeholder="type"
                ...
                <div class="post--info--item">
                    <b-field class="field-group flex-column">
                        ...
                        <treeselect class="custom--treeSelect" :show-count="true" :flat="true"
                            v-model="postInfo.categories" :multiple="true" :options="categories" />
                    </b-field>
                </div>
            </div>
        </div>
