                ...
                <div class="filter--items--right">
                    ...
                    <div class="input--fuild">
                        <v-select
                            ...
                            v-model="order"
                            label="title"
                            class="select--with--icon w-100 w-fuild-md v--select--scroll"
                        >
                    ...
                    <div class="input--fuild">
                        <v-select
                            ...
                            label="name"
                            multiple
                            :placeholder="$t('sortByCategories')"
        ...
        >
            ...
            <div class="d-flex justify-content-center">
                <button
                    ...
                    @click="unsetDate()"
                >{{$t('unsetDate')}}</button>
                <button class="button is-primary" @click="setDate" type="button">{{$t('setDate')}}</button>
            </div>
        </b-modal>
    </div>
</template>
...
import { allFormat, order } from "./../../helpers/Variables";
