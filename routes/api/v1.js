    ...
    group: {
        ...
        "/media": {
            group: {
                ...
                "GET /thumbnails": "v1/MediaController.findThumbnails",
                "GET /types": "v1/MediaController.findTypes",
                "GET /extensions": "v1/MediaController.findExtensions",
                ...
                "PUT /thumbnail/:id": {
                    middleware: authenticate(),
                    handler: "v1/MediaController.updateThumbnail",
                },
                "PUT /:id": {
                    middleware: authenticate(),
